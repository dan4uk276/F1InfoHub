...
public class TeamStat {
    ...
    @Column(name = "wcc_position")
    private Long wccPosition;

    public Long getWccPosition() {
        return wccPosition;
    }

    public void setWccPosition(Long wccPosition) {
    ...
    public Long getFastestLaps() {
        return fastestLaps;
    }

    public void setFastestLaps(Long fastestLaps) {
